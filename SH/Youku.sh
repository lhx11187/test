...
#/etc/storage/bin/n2n/edge -d lucktu -a 10.10.4.13 -c blackduck -k 123 -l n2n.lucktu.com:10082 &
/etc/storage/bin/n2n/edge -d udpfile_v1 -a 10.10.5.13 -c blackduck -k 123 -l n2n.udpfile.com:10082 &
/etc/storage/bin/n2n/edge -d llfj_v1 -a 10.10.6.13 -c blackduck -k 123 -l n2n.llfj.party:10082 &
/etc/storage/bin/n2n/edge -d laiyx_v1 -a 10.10.7.13 -c blackduck -k 123 -l n2ndx.laiyx.win:10082 &
/etc/storage/bin/n2n/edge -d rb_v1 -a 10.10.8.13 -c blackduck -k 123 -l 106.186.30.16:6489 &
